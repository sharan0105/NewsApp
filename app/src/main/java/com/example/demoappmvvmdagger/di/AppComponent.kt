...
import com.example.demoappmvvmdagger.ProfileAndSettings
...
@Singleton
@Component(modules = [RetrofitModule::class,ViewModelModule::class,ProfileRefreshModule::class])
interface AppComponent {
    ...
    fun injectProfileAndSettingsActivity(profileActivity:ProfileAndSettings)
